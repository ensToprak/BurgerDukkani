...
public class DoubleKofteBurger implements Menu {
    float fiyat;

    public float menu() {
        BurgerMenuFactory etFactory = UrunSecim.getFactory(1);

        Et et = etFactory.getEt(2);
        et.adet(Adet.DOUBLE);
        fiyat += et.fiyat();
